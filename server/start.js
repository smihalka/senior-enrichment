...
//The code below works because `.use` returns `this` which is `app`. So what we want to return in the
//`module.exports` is `app`, and we can chain on that declaration because each method invokation
//returns `app` after mutating based on the middleware functions
